...
class _SnakeGameState extends State<SnakeGame> {
  ...
  final FontStyle = TextStyle(color: Colors.white, fontSize: 20.0);
  ...
  void startGame() {
    ...
    snake.add([snake.first[0], snake.first[1] - 1]); //Snake Head
  ...
  bool checkGameOver() {
    ...
    for (var i = 1; i < snake.length; ++i) {
      if (snake[i][0] == snake.first[0] && snake[i][1] == snake[1]) {
        return true;
      }
    }
